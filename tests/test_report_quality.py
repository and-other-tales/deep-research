...
from othertales.deepresearch.enhanced_graph import graph
...
def research_agent(request):
    ...
    return request.config.getoption("--research-agent") or os.environ.get("RESEARCH_AGENT", "graph")
